    ...
    return (
        <div className="bg-white w-full flex flex-col items-center justify-center min-h-screen h-auto">
            ...
            <section className="flex flex-col w-full h-full mt-44 desktop:px-40 laptop:px-10 tablet:px-10 mobile:px-0 mb-10">
                ...
                <div className='mt-3 mobile:border-0 tablet:border-8 tablet:border-gray-700 rounded-md p-9 w-full h-full gap-4 flex mobile:flex-col tablet:flex-row laptop:flex-row desktop:flex-row mobile:gap-x-0  tablet:gap-x-5 laptop:gap-x-4 desktop:gap-x-0'>
